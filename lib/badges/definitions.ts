...
export const badgeDefinitions = [
  ...
  { id: 16, name: 'Profil-pransen', icon: '📝', category: 'starter' as const, description: 'Fylte ut profilen sin for første gang', auto_criteria: 'profile_complete' },
  ...
  { id: 7, name: 'Regnvæksjer', icon: '🌧️', category: 'vanlig' as const, description: 'Stilte opp i dårlig vær', auto_criteria: null },
  ...
  { id: 10, name: 'Mentor', icon: '🎓', category: 'veteran' as const, description: 'Paret med nybegynner', auto_criteria: null },
  ...
  // Aktivitetsmerker
  { id: 17, name: 'Bakeren', icon: '🧁', category: 'aktivitet' as const, description: 'Laget kake til dugnad', auto_criteria: null },
  { id: 18, name: 'Dørbankeren', icon: '🚪', category: 'aktivitet' as const, description: 'Delte ut lapper i forkant av innsamling', auto_criteria: null },
  { id: 19, name: 'Lottofansen', icon: '🎰', category: 'aktivitet' as const, description: 'Solgte lotteri', auto_criteria: null },
]
