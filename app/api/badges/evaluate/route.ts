...
// Aktivitet-, 17mai-, sommerkonsert- og seminar-merker indikerer event-deltakelse når event_id er satt.
...
const PARTICIPATION_BADGE_IDS = new Set(
  badgeDefinitions
    .filter(b => b.category === 'aktivitet' || b.category === '17mai' || b.category === 'sommerkonsert' || b.category === 'seminar')
    .map(b => b.id)
)
